...
def remove_dark_mode_classes(content):
    ...
    # More precise pattern that only matches dark: followed by valid CSS class characters
    # and stops at word boundaries (space, quote, or closing tag)
    pattern = r' dark:[a-zA-Z0-9\-_:/.\[\]]+(?=[\s"\'>])'

      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 py-10">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
            <Card className="bg-white border-2 border-slate-200 shadow-lg hover:shadow-xl transition-all duration-200">
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-slate-900">{stats.running}</p>
                  </div>
                  <div className="w-14 h-14 bg-emerald-100 rounded-xl flex items-center justify-center border-2 border-emerald-200">
            ...
            <CardContent className="p-6">
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="flex-1 relative">
                  ...
                  <Input
                    ...
                    className="pl-10 bg-slate-50 border-2 border-slate-200 focus:border-blue-500"
                  />
                </div>
                <div className="flex gap-2">
                  <Button
                    ...
                    className="border-2 border-slate-200 hover:border-blue-500"
                  >
              ...
              {isFilterOpen && (
                <motion.div
                  ...
                  className="mt-6 pt-6 border-t-2 border-slate-200"
                >
                  <div className="flex flex-wrap gap-3">
                    ...
                    {['all', 'running', 'completed', 'draft'].map((status) => (
                      <Button
                        ...
                        className="capitalize border-2 hover:border-blue-500"
                      >
            ...
            <div className="space-y-6">
              {filteredAndSortedCampaigns.map((campaign, index) => {
                ...
                return (
                  ...
                  >
                    <Card className="bg-white border-2 border-slate-200 shadow-lg hover:shadow-xl transition-all duration-200 group hover:border-blue-300">
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-6">
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <span className="text-sm text-slate-600 block">Recipients</span>
                              ...
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <span className="text-sm text-slate-600 block">Delivered</span>
                                  <span className="font-semibold text-slate-900 text-lg">
                              ...
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <span className="text-sm text-slate-600 block">Success Rate</span>
                                  <span className="font-semibold text-slate-900 text-lg">
                          ...
                          <div className="flex items-center gap-3 ml-6">
                            <Link href={`/campaigns/${campaign.id}`}>
                              <Button variant="outline" size="sm" className="opacity-0 group-hover:opacity-100 transition-all duration-200 border-2 hover:border-blue-500">
          ...
          >
            <p className="text-slate-600">
              ...
              {(searchTerm || statusFilter !== 'all') && (
                <Button
                  variant="link"
                  className="ml-3 p-0 h-auto text-blue-600 hover:text-blue-700"
                  onClick={() => {
                    setSearchTerm('')
                    setStatusFilter('all')
                  }}

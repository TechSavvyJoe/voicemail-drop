                ...
                <div className="flex-1">
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-12 h-12 text-base bg-white/50 border-2 border-slate-300 focus:border-blue-500"
                    />
                  </div>
                </div>
              ...
              <div className="space-y-6">
                {filteredCustomers.map((customer, index) => (
                  <motion.div
                    ...
                    className="group"
                  >
                    <div className="p-6 rounded-xl border-2 border-slate-200 bg-white/60 backdrop-blur-sm hover:bg-white hover:border-blue-300 transition-all duration-300 hover:shadow-lg cursor-pointer">
                      ...
                      <div className="flex items-center gap-3 pt-4 border-t border-slate-200">
                        <Link href={`/customers/${customer.id}`}>
                          <Button variant="outline" size="sm" className="border-2 hover:bg-blue-50 hover:border-blue-300">
                            <Eye className="w-4 h-4 mr-2" />
                            View Profile
                          </Button>
                        </Link>
                        <Link href={`/customers/${customer.id}/edit`}>
                          <Button variant="outline" size="sm" className="border-2 hover:bg-green-50 hover:border-green-300">
                            <Edit className="w-4 h-4 mr-2" />
                            Edit Info
                          </Button>
                        </Link>
                        <Button variant="outline" size="sm" className="text-red-600 hover:text-red-700 hover:bg-red-50 hover:border-red-300 border-2">

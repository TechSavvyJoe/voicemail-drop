      ...
      <div className="container mx-auto px-6 py-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {statCards.map((stat, index) => (
            ...
            >
              <Link href={stat.href}>
                <Card className="cursor-pointer hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-white/90 backdrop-blur-sm border-2 border-slate-200 hover:border-blue-300 group">
